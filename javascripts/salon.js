...
function cuscino_cilindrico(color){
  var dom2D = PROD1x1([INTERVALS(1)(48),INTERVALS(1)(48)])
...
var showSalon = function(){  
    ...
    var bracciolo = T([0,1,2])([0.53,-0.08,1.85])(R([1,2])(-PI/2)(S([0,1,2])([0.43,0.45,0.39])(cuscino_cilindrico(verde))))
    // DRAW(bracciolo)
    ...
    /////////////////////////////////////////////////////////////////////
    var poltrona = S([0,1,2])([1.4,1.4,1.4])(T([0,1])([4,10.5])(STRUCT([sfera,bracciolo,zone_rosa,zone_rosse,cuscino,strutt_bianco,cuboid_appoggio])))
